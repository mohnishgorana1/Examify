...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#e0f7fa] via-white to-[#f1f8e9] px-6 py-16 md:px-20">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          {[
            ...
            <div
              key={index}
              className="bg-white border border-gray-100 shadow-md hover:shadow-lg hover:shadow-emerald-100 transition-all duration-300 rounded-xl p-6 text-left"
            >
